...
def tricky_method(a_string_param, an_array_param)
  a_string_param += "rutabaga" # doesn't mutate caller
  an_array_param << "rutabaga" # mutates array
end
...
def tricky_method_two(a_string_param, an_array_param)
  a_string_param << 'rutabaga' # mutataes string
  an_array_param = ['pumpkins', 'rutabaga'] # = is a non-mutating operation
end
